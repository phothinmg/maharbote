...
const mbaht = [
 ...
 export default function Maharbote (){
  const [d, setSelectValueD] = useState('');
    ...
    else if(ceMmDateTime.cal_pyathada(mdt.mm,mdt.w) == 1){ yyz = 'ပြသဒါး'}
    else if(ceMmDateTime.cal_pyathada(mdt.mm,mdt.w) == 2){yyz = 'မွန်းလွဲပြသဒါး'}
    else {yyz=''}
