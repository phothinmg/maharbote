...
export default function Home() {
  ...
  let natkstr;
  if (my && mwd) {
    natkstr = new ceMmTranslate().T(natkes, 1);
  } else {
    natkstr = "";
  }
  ...
  let result3 = "";
  if (my && mwd) {
    result = `မြန်မာ သက္ကရာဇ် ${num2ms(my)} ခုနှစ် ${
      mwda[mwd]
    }   နေ့မွေးဖွားသူသည်`;
    ...
    result =
      "မဟာဘုတ် ဖွားဇာတာသိရှိနိုင်ရန်အတွက် မွေးဖွားသည့် ခရစ် သက္ကရာဇ် မွေးနေ့ နှင့် မွေးနေ့နံ ကိုထည့်သွင်းရွေးချယ်ပါ။ရွေးချယ်ပီးသည်နှင့်အောက်တွင် အဟောကိုဖတ်ရှုနိူင်ပါသည်။";
    result2 = "";
    result3 = "";
  }
  // -----------
  ...
  if (my && mwd) {
    ...
    mbah = "အချက်အလက်များဖြည့်သွင်းပေးပါ";
  }
  return (
    <>
      <div className="mb">
        ...
        <details>
          ...
          <p>
            ယခု project ကိုကျနော် javascript
            လေ့လာရင်းလုပ်ခဲ့တာဖြစ်ပါသည်။တွက်ချက်ပုံနှင့်ဟောချက်များအမှားအယွင်းတစ်စုံတစ်ရာ
            ရှိပါကနားလည်ပေးပါ။
          </p>
        </details>
        <hr />
        ...
        <details>
          <summary>
            အချက်အလက်များဖြည့်သွင်းပြီးသည်နှင့်ဖွားဇာတာအဟောဖတ်ရန်မြားကိုနှိပ်ဖတ်ပါ
          </summary>
          <p>{mbah}</p>
        </details>
        <hr />
        <details>
          ...
          <ol>
            <li>
              <a
                href="https://coolemerald.blogspot.com/2013/06/algorithm-program-and-calculation-of.html?fbclid=IwAR0RXq5AsMxtoKKmLGxcLJgmOi9Cu3OMZOFc9BLpR-zGqXWEMxsV0pRSBbk"
                target="_blank"
              >
                {" "}
            ...
            <li>
              <a
                href="https://cool-emerald.blogspot.com/2013/12/myanmar-astrological-calendar-days.html"
                target="_blank"
              >
